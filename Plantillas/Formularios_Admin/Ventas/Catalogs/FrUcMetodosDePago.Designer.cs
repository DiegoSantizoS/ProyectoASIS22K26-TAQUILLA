...
{
    partial class FrUcMetodosDePago
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            DgvMetodoDePago = new Componentes.CustomDataGridView();
            ...
            TlpDivFormAndDgv.Controls.Add(DgvMetodoDePago, 0, 1);
            ...
            LbID.Size = new Size(170, 23);
            LbID.TabIndex = 11;
            LbID.Text = "ID Método De Pago";
            ...
            // DgvMetodoDePago
            // 
            DgvMetodoDePago.AllowUserToAddRows = false;
            DgvMetodoDePago.AllowUserToResizeColumns = false;
            DgvMetodoDePago.AllowUserToResizeRows = false;
            ...
            DgvMetodoDePago.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle1;
            DgvMetodoDePago.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            DgvMetodoDePago.BackgroundColor = Color.FromArgb(37, 38, 43);
            DgvMetodoDePago.BorderStyle = BorderStyle.None;
            DgvMetodoDePago.CellBorderStyle = DataGridViewCellBorderStyle.SingleHorizontal;
            DgvMetodoDePago.ColumnHeadersBorderStyle = DataGridViewHeaderBorderStyle.None;
            ...
            DgvMetodoDePago.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle2;
            ...
            DgvMetodoDePago.DefaultCellStyle = dataGridViewCellStyle3;
            DgvMetodoDePago.Dock = DockStyle.Fill;
            DgvMetodoDePago.EnableHeadersVisualStyles = false;
            DgvMetodoDePago.Font = new Font("Segoe UI", 9.5F);
            DgvMetodoDePago.GridColor = Color.FromArgb(58, 60, 66);
            DgvMetodoDePago.Location = new Point(0, 300);
            DgvMetodoDePago.Margin = new Padding(0);
            DgvMetodoDePago.MultiSelect = false;
            DgvMetodoDePago.Name = "DgvMetodoDePago";
            DgvMetodoDePago.ReadOnly = true;
            DgvMetodoDePago.RowHeadersVisible = false;
            DgvMetodoDePago.RowHeadersWidth = 51;
            DgvMetodoDePago.RowTemplate.Height = 36;
            DgvMetodoDePago.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            DgvMetodoDePago.Size = new Size(1050, 400);
            DgvMetodoDePago.TabIndex = 2;
            // 
            // FrUcMetodosDePago
            // 
        ...
        private Componentes.CustomDataGridView DgvMetodoDePago;
    }
}

namespace Forms_Admin.Funciones.Catalogs
{
    partial class FrUcCiudades
    {
        ...
        private void InitializeComponent()
        {
            ...
            DgvCiudades = new Componentes.CustomDataGridView();
            ...
            TlpDivFormAndDgv.Controls.Add(DgvCiudades, 0, 1);
            ...
            DgvCiudades.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle4;
            DgvCiudades.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            DgvCiudades.BackgroundColor = Color.FromArgb(37, 38, 43);
            DgvCiudades.BorderStyle = BorderStyle.None;
            DgvCiudades.CellBorderStyle = DataGridViewCellBorderStyle.SingleHorizontal;
            DgvCiudades.ColumnHeadersBorderStyle = DataGridViewHeaderBorderStyle.None;
            ...
            DgvCiudades.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle5;
            ...
            DgvCiudades.DefaultCellStyle = dataGridViewCellStyle6;
            DgvCiudades.Dock = DockStyle.Fill;
            DgvCiudades.EnableHeadersVisualStyles = false;
            DgvCiudades.Font = new Font("Segoe UI", 9.5F);
            DgvCiudades.GridColor = Color.FromArgb(58, 60, 66);
            DgvCiudades.Location = new Point(0, 300);
            DgvCiudades.Margin = new Padding(0);
            ...
            DgvCiudades.RowTemplate.Height = 36;
            DgvCiudades.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            DgvCiudades.Size = new Size(1050, 400);
            DgvCiudades.TabIndex = 2;
            // 
            // FrUcCiudades
            // 
        ...
        private Componentes.CustomDataGridView DgvCiudades;
    }
}

namespace Forms_Admin.Funciones.Catalogs
{
    partial class FrUcGeneros
    {
        ...
        private void InitializeComponent()
        {
            ...
            DgvGeneros = new Componentes.CustomDataGridView();
            ...
            TlpDivFormAndDgv.Controls.Add(DgvGeneros, 0, 1);
            ...
            LbID.Size = new Size(189, 23);
            LbID.TabIndex = 11;
            LbID.Text = "ID Generos de Película";
            ...
            LbTitulo.TabIndex = 0;
            LbTitulo.Text = "GENEROS DE PELÍCULA";
            ...
            DgvGeneros.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle1;
            DgvGeneros.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            DgvGeneros.BackgroundColor = Color.FromArgb(37, 38, 43);
            DgvGeneros.BorderStyle = BorderStyle.None;
            DgvGeneros.CellBorderStyle = DataGridViewCellBorderStyle.SingleHorizontal;
            DgvGeneros.ColumnHeadersBorderStyle = DataGridViewHeaderBorderStyle.None;
            ...
            DgvGeneros.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle2;
            ...
            DgvGeneros.DefaultCellStyle = dataGridViewCellStyle3;
            DgvGeneros.Dock = DockStyle.Fill;
            DgvGeneros.EnableHeadersVisualStyles = false;
            DgvGeneros.Font = new Font("Segoe UI", 9.5F);
            DgvGeneros.GridColor = Color.FromArgb(58, 60, 66);
            DgvGeneros.Location = new Point(0, 300);
            DgvGeneros.Margin = new Padding(0);
            ...
            DgvGeneros.RowTemplate.Height = 36;
            DgvGeneros.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            DgvGeneros.Size = new Size(1050, 400);
        ...
        private Componentes.CustomDataGridView DgvGeneros;
    }
}
